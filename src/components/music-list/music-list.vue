...
const backdrop = prefixTransform('backdrop-filter')
...
export default {
  ...
  watch: {
    // 监听scrollY的值，实时更新layer的transform在Y轴的偏移量
    scrollY(y) {
      // 滚动距离在minTranslateY到scrollY之间
      ...
      // 当music-list滚动的y小于minTranslateY时，改变image的z-index
